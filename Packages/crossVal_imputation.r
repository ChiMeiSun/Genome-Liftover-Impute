...
# args = c("Snakemake_Liftover_Impute/Output/Phased/IMAGE_phased_comchr.vcf.gz",
#     "Snakemake_Liftover_Impute/Output/Phased/bcftools_lifted_qc_phased.bref3",
#     "SCRIPTS/packages/beagle.22Jul22.46e.jar","5","10","80000","10",
#     "RESULTS/check_imputation/cors_CV_gt_imp.pdf",
#     "RESULTS/check_imputation/CV_gt_imp_rep5_fold5.txt")
